...
COLD_IDLE="${COLD_IDLE:-90s}"
COOLDOWN_IDLE="${COOLDOWN_IDLE:-180s}"
...
STEP_RATES_DEFAULT=("50/1s" "100/1s" "150/1s" "200/1s")
STRESS_RATES_DEFAULT=("400/1s")
